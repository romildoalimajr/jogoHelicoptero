function start() {
    ...
    let jogo = {};
    let velocidade = 5;
    let posicaoY = parseInt(Math.random() * 354);
    let podeAtirar = true;
    let fimJogo = false;
    let pontos = 0;
    let salvos = 0;
    ...
    function colisao() {
        ...
        if (colisao3.lenght > 0) {
            ...
            posicaoY = parseInt(Math.random() * 354);
            $("#inimigo1").css("left", 493);
            $("#inimigo1").css("top", posicaoY);
        }

        if (colisao4.lenght > 0) {
            pontos = pontos + 50;
            inimigo2X = parseInt($("#inimigo2").css("left"));
            inimigo2Y = parseInt($("#inimigo2").css("top"));
            $("#inimigo2").remove();
    ...
    function reposicionaInimigo2() {
        var tempoColisao4 = window.setInterval(reposiciona, 5000);
    ...
    function placar() {
        $("#placar").html("<h2> Scores.: " + pontos + " | Salvos.: " + salvos + " | Perdidos.: " + perdidos + "<h2>");
    }
